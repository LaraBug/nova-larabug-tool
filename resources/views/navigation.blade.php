<router-link tag="h3" :to="{name: 'nova-larabug-tool'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    ...
    <span class="sidebar-label">
        {{ config('services.larabug.title', 'LaraBug Exceptions') }}
    </span>
</router-link>
